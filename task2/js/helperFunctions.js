...
var fileName;	
if(handheld) {
	fileName = (is_IE | is_Firefox ? "11.csv" : "11.csv"); //IE & Firefox cannot read Unicode saved files
} else {
	fileName = (is_IE | is_Firefox ? "11.csv" : "11.csv");
}//else
...
// 		select.options[0] = new Option("MODEL NAME", "", true, false)
		
// 		//Create options - all the artists in the current year
// 		var options = data.map(function(d) { return d.title; });
...
//What to do when searched for title
